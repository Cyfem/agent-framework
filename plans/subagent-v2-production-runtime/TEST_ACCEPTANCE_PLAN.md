...
本小节只冻结 C7c-5c 的初始 create/replay Store。不暴露任意 record CAS，也不实现 delivery/spool、ACK/poll wait、listener/client、production durable adapter 或 reconnect；保留的 `STORE03`、`STORE04` 与 `STORE07` 编号留给 C7c-5d 的真实 attachment/delivery/wait mutation。
