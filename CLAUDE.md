...
- 当前 checkout 已完成 C6，并交付 C7 的 Core transport v1 与 recoverable Executor settle 地基；Worker/Process/HTTP placement 和 C8–C9 分布式能力仍须以源码、测试和 README 证明，不能把 plans 中的目标 API 当作当前行为。
